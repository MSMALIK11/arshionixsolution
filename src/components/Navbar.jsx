        ...
        >
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        <button
                            ...
                            className="px-5 py-2 rounded-xl bg-gradient-to-r from-brand-500 to-violet-600 text-white text-sm font-semibold hover:shadow-lg hover:shadow-brand-500/30 hover:-translate-y-0.5 transition-all duration-200"
                        >
                            Get a Quote
                        </button>
                    </div>
            ...
            >
                <div className="bg-background/95 backdrop-blur-xl border-b border-border px-6 pb-6 space-y-1">
                    ...
                    <button
                        onClick={() => handleNavClick("#contact")}
                        className="w-full mt-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-brand-500 to-violet-600 text-white text-sm font-semibold"
                    >
                        Get a Quote
                    </button>
                </div>
